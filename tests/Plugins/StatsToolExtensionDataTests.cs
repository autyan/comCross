...
public class StatsToolExtensionDataTests
{
    ...
    public void OnContextSnapshot_TracksActiveWorkloadAndSessionCount()
    {
        ...
        var snapshot = new ExtensionContextSnapshot(
            Sessions:
            [
                new ExtensionSessionSnapshot("s1", "Session 1", "plugin:test:a", "plugin.test", "a", "Connected", null, "Session 1", null, "PluginIcon", true, [], null, 0, 0),
                new ExtensionSessionSnapshot("s2", "Session 2", "plugin:test:b", "plugin.test", "b", "Disconnected", null, "Session 2", null, "PluginIcon", true, [], null, 0, 0)
            ],
