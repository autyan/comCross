...
public sealed class LocalizationService : IExtensibleLocalizationService
{
    ...
    private static Dictionary<string, string> GetEnglishTranslations()
    {
        return new Dictionary<string, string>
        {
            ...
            ["stream.export.plain"] = "Plain export",
            ["stream.export.slim"] = "Slim export",
            ["stream.export.detailed"] = "Detailed export",
            ["session.archive.label"] = "Archive",
            ["session.archive.status.disabled"] = "Not enabled",
            ["session.archive.status.enabled"] = "Writing",
            ["session.archive.status.stopped"] = "Stopped",
            ["session.archive.status.error"] = "Error",
            ["session.archive.tooltip"] = "Archive status: {0}. Enabled archive writes only new frames. Existing archive data is kept when writing stops.",
            ["session.archive.enable"] = "Enable",
            ["session.archive.stop"] = "Stop",
            ["session.archive.history"] = "History",
            ["session.archive.live"] = "Live",
            ["session.archive.enable.title"] = "Enable Session Archive",
            ...
            ["settings.nav.storage.page"] = "Storage",
            ["settings.nav.plugins"] = "Plugins",
            ["settings.nav.plugins.page"] = "Plugin Manager",
            ["settings.storage.title"] = "Storage",
            ["settings.storage.behavior.title"] = "Session logs",
            ["settings.storage.behavior.description"] = "Session logs use bounded file-backed landing buffers for live browsing, short-term export, and analysis sources. They may be cleaned automatically when configured limits are exceeded.",
            ["settings.storage.status.title"] = "Status",
            ["settings.storage.calibration"] = "Calibration",
            ["settings.storage.health"] = "Health",
            ["settings.storage.usage"] = "Landing buffer usage",
            ["settings.storage.refresh"] = "Refresh",
            ["settings.storage.limits.title"] = "Session log limits",
            ["settings.storage.limits.description"] = "These limits control bounded file-backed landing buffers. When limits are exceeded, older landed data may be cleaned according to the storage policy.",
            ["settings.storage.limit.global"] = "Global landing buffer limit (MB)",
            ["settings.storage.limit.session"] = "Per-session landing buffer limit (MB)",
            ["settings.storage.limit.segment"] = "Segment file limit (MB)",
            ["settings.storage.paths.title"] = "Directories",
            ["settings.storage.path.data"] = "Data directory",
            ["settings.storage.path.spool"] = "Session log buffer directory",
            ["settings.storage.openDataDirectory"] = "Open data directory",
            ["settings.storage.openSpoolDirectory"] = "Open buffer directory",
            ...
            ["notification.storage.limitExceeded"] = "Session log storage limit exceeded ({0} MB / {1} MB).",
            ["notification.storage.autoDeleteApplied"] = "Auto delete removed {0} session log files.",
            ["notification.storage.calibrationCompleted"] = "Storage calibration completed. Active tier: {0}.",
